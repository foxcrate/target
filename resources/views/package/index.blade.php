        ...
        <div class="col">
            <div class=" mb-4 rounded-3 shadow-sm">
              <div class="card-header py-3">
                <h4 class="my-0 fw-normal"><i class="far fa-handshake"></i> {{$package->name}}</h4>
              </div>
              <div class="card-body">
                <h1 class="card-title pricing-card-title">{{$package->cost}}<small class="text-muted fw-light">/ye</small></h1>
                ...
                <button type="button" class="w-100 btn btn-lg btn-outline-primary">إشترك</button>
              </div>
            </div>
        </div>
        @endforeach
