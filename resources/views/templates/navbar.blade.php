  ...
  <div class="container-fluid">
    ...
    @else
        <li class="nav-item dropdown">
            ...
            @else
                <a id="navbarDropdown"  href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre><img class="profile-img" src="{{asset('/images/company.jpg')}}" alt="">
                    {{-- {{ Auth::user()->name }} --}}
                </a>
            @endif
